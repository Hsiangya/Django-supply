...
class Company(models.Model):
    ...
    auth_type = models.SmallIntegerField(
        verbose_name="认证类型", choices=((1, "未认证"), (2, "认证中"), (3, "已认证")), default=1
    )
...
class CompanyAuth(models.Model):
    ...
    company = models.OneToOneField(
        verbose_name="公司", to="Company", on_delete=models.CASCADE
    )

    title = models.CharField(verbose_name="公司全称", max_length=64)
    unique_id = models.CharField(verbose_name="信用代码", max_length=64)
    licence_path = models.CharField(verbose_name="营业执照", max_length=256)  # 文件路径
    leader = models.CharField(verbose_name="法人", max_length=64)
    leader_identity = models.CharField(verbose_name="法人身份", max_length=64)

    leader_identity_front = models.CharField(
        verbose_name="身份证-人头", max_length=128
    )  # 文件路径
    leader_identity_back = models.CharField(
        verbose_name="身份证-国徽", max_length=128
    )  # 文件路径
